...
-- Keymaps
vim.keymap.set('n', '<C-p>', require('telescope.builtin').find_files, { desc = '[P]ick [F]ile' })
...
vim.keymap.set('n', '<leader>sl',
    function() require('telescope').extensions.bookmarks.bookmarks({ selected_browser = "chrome" }) end, {})
